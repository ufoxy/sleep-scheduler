        ...
        <section>
          <article className="flex-row">
            ...
            <div className="content-container flex-collumn centralize">
              <div
                style={{
                  borderLeft: "8px solid #6595DF",
                  borderRadius: "12px",
                  paddingLeft: "30px",
                }}
              >
                <h2 style={{ color: "#6595DF" }}>
          ...
          <article className="flex-row">
            <div
              className="content-container flex-collumn centralize"
              style={{ paddingRight: "3rem" }}
            >
              <div
                style={{
                  borderLeft: "8px solid #5D83D8",
                  borderRadius: "12px",
                  paddingLeft: "30px",
                }}
              >
                <h2 style={{ color: "#5D83D8" }}>
                  Como funciona o ciclo do sono?
                </h2>
                <p className="guide-p">
                  O ciclo do sono corresponde ao conjunto das fases do sono que
                  tem início a partir do momento que a pessoa adormece e vai até
                  a fase do sono REM, que é a fase do sono mais profunda e que
                ...
                <p className="guide-p">
                  ...
                  minutos por ciclo e normalmente são necessários 4 a 5 ciclos
                  por noite, o que correspondente a 8 horas de sono.
                </p>
              </div>
            </div>
          ...
          <article className="flex-collumn">
            ...
            <p className="guide-p">Existem 4 fases do sono, sendo elas:</p>
            <div className="flex-row">
              <img src={sleepStages} alt="" className="sleep-stages" />
              <div className="content-container flex-collumn">
                <div
                  style={{
                    borderLeft: "8px solid #5272BF",
                    borderRadius: "12px",
                    paddingLeft: "30px",
                  }}
                >
                  <p className="guide-p" style={{ paddingTop: "1rem" }}>
                    Na fase REM os olhos se movimentam muito rapidamente, os
                    batimentos cardíacos aumentam e os sonhos aparecem.
                  </p>
                  <p className="guide-p">
                    É difícil atingir o sono REM e, por isso é importante
                    diminuir a luz do ambiente e não usar o celular ou o
                    computador antes de dormir, pois assim é possível chegar ao
                    sono REM de forma mais fácil.
                  </p>
                </div>
              </div>
            </div>
          ...
          <article className="flex-row">
            <div className="content-container flex-collumn centralize">
              <div
                style={{
                  borderLeft: "8px solid #5B5C9F",
                  borderRadius: "10px",
                  paddingLeft: "30px",
                }}
              >
                <h2 style={{ color: "#5B5C9F" }}>
                  Por que precisamos dormir bem?
                </h2>
                <p className="guide-p">
                  Dormir bem é fundamental para o bom funcionamento do
                  organismo, pois é durante o sono que o organismo consegue
                  recuperar as energias, regular o nível de vários hormônios
                  fundamentais para o bom funcionamento do corpo e otimizar o
                  metabolismo.
                </p>
                <p className="guide-p">
                  Assim, quando não se tem uma boa noite de sono é possível que
                  se tenha algumas consequências, como alterações de humor,
                  aumento das inflamações no corpo, falta de energia e
                  enfraquecimento do sistema imune, por exemplo, além de também
                  aumentar o risco de desenvolver algumas doenças, como
                  obesidade, diabetes e pressão alta, por exemplo.
                </p>
              </div>
            </div>
            ...
            <article className="flex-row">
              ...
              <div className="centralize">
                <div className="centralize calculate-container flex-collumn-center">
                  ...
                  <p className="guide-p">
                    Veja que horas deve acordar ou ir dormir para ter uma boa
                    noite de sono usando a calculadora a seguir:
                  </p>
                  <BasicButton
                    children={"Calculate"}
                    color={"secondary"}
